...
global.reloadHandler = async function(restatConn) {
  ...
  conn.welcome = '@user 𝐁𝐢𝐞𝐧𝐯𝐞𝐧𝐢𝐝𝐱 𝐚𝐥 𝐦𝐞𝐣𝐨𝐫 𝐠𝐫𝐮𝐩𝐨 𝐝𝐞 𝐰𝐡𝐚𝐭𝐬𝐚𝐩𝐩.🌸';
  conn.bye = '@user 𝐂𝐮𝐢𝐝𝐚𝐭𝐞.🌸';
  conn.spromote = '@user 𝐒𝐞 𝐡𝐚 𝐮𝐧𝐢𝐝𝐨 𝐚𝐥 𝐠𝐫𝐮𝐩𝐨 𝐝𝐞 𝐚𝐝𝐦𝐢𝐧𝐬, 𝐁𝐢𝐞𝐧𝐯𝐞𝐧𝐢𝐝𝐱.🌸';
  conn.sdemote = '@user 𝐇𝐚 𝐚𝐛𝐚𝐧𝐝𝐨𝐧𝐚𝐝𝐨 𝐞𝐥 𝐠𝐫𝐮𝐩𝐨 𝐝𝐞 𝐚𝐝𝐦𝐢𝐧𝐬.🌸';
  ...
  conn.sRevoke = ' 𝐒𝐞 𝐡𝐚 𝐦𝐨𝐝𝐢𝐟𝐢𝐜𝐚𝐝𝐨 𝐞𝐥 𝐞𝐧𝐥𝐚𝐜𝐞 𝐝𝐞𝐥 𝐠𝐫𝐮𝐩𝐨.🌸';;
